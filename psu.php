...
<center>
<form method='POST' action = 'psu_inaction.php'>
...
if ($result->num_rows > 0) {
     ...
     while($row = $result->fetch_assoc()) {
         echo "<tr><td>" . $row["sn"]. "</td><td>" . $row["name"]. "</td><td>" . $row["quantity"] . "</td><td>". $row["ppu"]. "</td><td><a href =psuedit.php?sn=".$row["sn"].">Edit</a></td><td><a href=psudel.php?sn=".$row["sn"].">Delete</a></td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
